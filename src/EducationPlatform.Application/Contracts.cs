...
public sealed record CreateTeacherRequest(string UserName, string Password, string FullName, string PhoneNumber, string? WhatsApp, decimal DefaultPerSessionRate, IReadOnlyList<Guid> SubjectIds, IReadOnlyList<Guid> CurriculumIds, string? PreferredPayoutMethod, string? EWalletNumber, string? InstaPayIdentifier, string? ZoomMeetingUrl = null, string DefaultCurrency = "EGP", IReadOnlyList<TeacherStageRateRequest>? StageRates = null);
public sealed record UpdateTeacherRequest(string FullName, string PhoneNumber, string? WhatsApp, decimal DefaultPerSessionRate, IReadOnlyList<Guid> SubjectIds, IReadOnlyList<Guid> CurriculumIds, string? PreferredPayoutMethod, string? EWalletNumber, string? InstaPayIdentifier, string Status, string? ZoomMeetingUrl = null, string DefaultCurrency = "EGP", IReadOnlyList<TeacherStageRateRequest>? StageRates = null);
public sealed record TeacherResponse(Guid Id, string FullName, string PhoneNumber, string? WhatsApp, decimal DefaultPerSessionRate, string Status, string? MaskedPayoutDestination, string? ZoomMeetingUrl = null, string DefaultCurrency = "EGP", IReadOnlyList<TeacherStageRateResponse>? StageRates = null);
